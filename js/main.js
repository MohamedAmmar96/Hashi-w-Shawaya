...
$(document).ready(function() {
    ...
    $(".mo-tabs a").on("shown.bs.tab", function(e) {
        let $owl = $(".my-tabs .owl-carousel");
        $owl.trigger('refresh.owl.carousel');
    });

    //This is To make faetures as slider in small screens
    if ($(window).width() <= 991) {
        $(".my-tabs .make-slider").addClass("owl-carousel owl-theme");
        $(".make-slider .sub-item").removeClass("owl-carousel");
        $('.my-tabs .owl-carousel').owlCarousel({
            loop: true,
            autoplay: true,
            autoplayTimeout: 4000,
            smartSpeed: 800,
        ...
        $(".my-tabs .make-slider").removeClass("owl-carousel");
        $(".make-slider .sub-item").removeClass("owl-carousel");
    };
